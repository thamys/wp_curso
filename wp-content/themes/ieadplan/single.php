...
<?php
      ...
      <div class="row">
        <h1 class="title border-yellow">Como agradar o coração de Deus?</h1>
        <div class="text text-center text-italic">
        ...
        <img class="img-responsive" src="<?php echo get_template_directory_uri() ?>/assets/img/banner.png">
        <div class="text">
